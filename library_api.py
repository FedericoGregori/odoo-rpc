...
class LibraryAPI:
    ...
    def write(self, title, book_id):
        vals = {'name': title}
        return self.execute('write', [[book_id], vals])

    def unlink(self, book_id):
        return self.execute('unlink', [[book_id]])


if __name__ == '__main__':
    # Sample test configurations
    srv, db, port = 'localhost', 'odoo-12-dev-essentials-library', 8069
